import{_ as s,o as n,c as a,e as p}from"./app-d898f4a9.js";const o={},t=p(`<h1 id="项目配置" tabindex="-1"><a class="header-anchor" href="#项目配置" aria-hidden="true">#</a> 项目配置</h1><p>FiveAdmin 提供了统一的配置入口，本章节介绍 FiveAdmin 环境、功能及外观的配置方式。</p><h2 id="环境配置" tabindex="-1"><a class="header-anchor" href="#环境配置" aria-hidden="true">#</a> 环境配置</h2><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// .env 所有环境都被加载</span>
