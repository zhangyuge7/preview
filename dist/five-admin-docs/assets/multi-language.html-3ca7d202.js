import{_ as u,r as p,o as i,c as k,a as n,b as s,d as a,w as t,e as c}from"./app-2c78fe49.js";const d={},g=n("h1",{id:"多语言",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#多语言","aria-hidden":"true"},"#"),s(" 多语言")],-1),m={class:"custom-container tip"},h=n("p",{class:"custom-container-title"},"提示",-1),y=n("p",null,"FiveAdmin提供了开箱即用的多语言配置，已配置的有中文简体、中文繁体、英文。",-1),_=n("h2",{id:"使用",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#使用","aria-hidden":"true"},"#"),s(" 使用")],-1),f=n("p",null,[s("FiveAdmin提供了开箱即用的多语言配置，已配置的有中文简体、中文繁体、英文。使用起来很简单，你只需要在 "),n("strong",null,"/src/i18n/pages/"),s(" 下新建一个目录并创建对应语言文本文件即可。目录名随意，文件名必须是en.js、zh-cn.js、zh-tw.js")],-1),v=n("div",{class:"language-text","data-ext":"text"},[n("pre",{class:"language-text"},[n("code",null,`src
├─i18n
│  └─pages
...
`)])])],-1),x=n("div",{class:"language-javascript","data-ext":"js"},[n("pre",{class:"language-javascript"},[n("code",null,[n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"default"),s(),n("span",{class:"token punctuation"},"{"),s(`
  ...
  `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),s(`
`),n("span",{class:"token punctuation"},"}"),s(`
`)])])],-1),z=c(`<p>在&lt;template&gt;中使用</p><div class="language-html" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>span</span><span class="token punctuation">&gt;</span></span>{{ $t(&#39;system.menu&#39;) }}<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>span</span><span class="token punctuation">&gt;</span></span>
</code></pre></div><p>在 JavaScript 中使用</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> t <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;@/i18n&#39;</span>
